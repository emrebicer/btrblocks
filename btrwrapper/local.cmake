...
target_link_libraries(btrblocks btrfiles croaring tbb csv-parser)

set(BTRWRAPPER_PUBLIC_INCLUDE_DIR ${CMAKE_CURRENT_LIST_DIR} ${BTR_INCLUDE_DIR} ${BTRFILES_INCLUDE_DIR} ${CROARING_INCLUDE_DIR} ${TBB_INCLUDE_DIR} ${CSV_INCLUDE_DIR})
